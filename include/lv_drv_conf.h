...
#  if EVDEV_CALIBRATE
#    define EVDEV_HOR_MAX         0               /*to invert axis swap EVDEV_XXX_MIN by EVDEV_XXX_MAX*/
#    define EVDEV_HOR_MIN      4096              /*"evtest" Linux tool can help to get the correct calibraion values>*/
